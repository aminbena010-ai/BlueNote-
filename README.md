...
- **[Contributing Guide](docs/CONTRIBUTING.md)**: Coding standards and PR workflows.
- **[Architecture Overview](docs/ARCHITECTURE.md)**: Deep dive into the internal design.
